...
if(!process.env.FRONTEND_PRODUCTION_URL) {
    throw new Error("FRONTEND_PRODUCTION_URL is not defined in environment variables");
}

if(!process.env.FRONTEND_DEVELOPMENT_URL) {
    throw new Error("FRONTEND_DEVELOPMENT_URL is not defined in environment variables");
}
